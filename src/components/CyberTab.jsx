...
export default function Desktop(props) {
    const group = useRef();
    const { nodes, materials } = useGLTF('/models/3d/cyberpunk_laptop_concept_design.glb')

    const videoTexture = useVideoTexture('/video/192779-893446888.mp4');
    ...
    useEffect(() => {
        if (videoTexture) {
            // Rotate the video texture 90 degrees
            videoTexture.flipY = false;
            videoTexture.flipX = true;
...
useGLTF.preload('/models/3d/cyberpunk_laptop_concept_design.glb')
